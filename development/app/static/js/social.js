        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.results>0) {
                    ...
                    if ($('#mailru_btn').length > 0) {
                        if (data.mailru.length > 0) {
                            $('#mailru_btn').removeClass('hidden');
                            $('#mailru_btn, .btn-tw').attr('href', data.mailru);
                        } else {
                            $('#mailru_btn').addClass('hidden');
                        }
                    }
                    $( '.btn-social' ).on( 'click', function( event ) {
                        popupCenter( $( this ).attr( 'href' ), 580, 570 );
...
function registartionfromSocial( services ) {
    ...
    var captchaV3 = $.trim( $( "input[name=captchaV3]" ).val() );
